...
<body>
    ...
    <div class="form-container">
        ...
        <form action="insertwedd" method="post">
            ...
            <div class="form-floating mb-3">
                <textarea class="form-control" id="requests" name="special_requests" placeholder="Special Requests" style="height: 100px"></textarea>
